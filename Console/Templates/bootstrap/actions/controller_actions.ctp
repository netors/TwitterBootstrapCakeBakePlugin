...
<?php if ($wannaUseSession): ?>
				$this->Session->setFlash(__('The <?php echo strtolower($singularHumanName); ?> has been saved'), 'default', array(), 'success');
...
<?php if ($wannaUseSession): ?>
				$this->Session->setFlash(__('The <?php echo strtolower($singularHumanName); ?> could not be saved. Please, try again.'), 'default', array(), 'error');
<?php endif; ?>
			}
		}
<?php
...
<?php if ($wannaUseSession): ?>
			$this->Session->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> deleted'), 'default', array(), 'success');
...
<?php if ($wannaUseSession): ?>
		$this->Session->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> was not deleted'), 'default', array(), 'error');
<?php else: ?>
...
<?php endif; ?>
	...
	public function <?php echo $admin ?>deactivate($id = null) {
		...
		if ($this-><?php echo $currentModelName; ?>->updateAll(array('is_active'=>0),array('<?php echo $currentModelName; ?>.id'=>$id))) {
			$this->Session->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> deactivated'), 'default', array(), 'success');
			$this->redirect($this->referer());
		}
		$this->Session->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> was not deactivated'), 'default', array(), 'error');
		$this->redirect($this->referer());
	}
	...
	public function <?php echo $admin ?>activate($id = null) {
		...
		if ($this-><?php echo $currentModelName; ?>->updateAll(array('is_active'=>1),array('<?php echo $currentModelName; ?>.id'=>$id))) {
			$this->Session->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> activated'), 'default', array(), 'success');
			$this->redirect($this->referer());
		}
		$this->Session->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> was not activated'), 'default', array(), 'error');
		$this->redirect($this->referer());
	}