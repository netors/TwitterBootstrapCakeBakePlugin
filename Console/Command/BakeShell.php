 ...
 * Command-line code generation utility to automate programmer chores.
 *
 * This file is based on original BakeShell script by CakePHP
 * it has been modified to build files needed for this Plugin
 *
 * @package       TwitterBootstrapCakeBake.Console.Command
 */
class BakeShell extends AppShell {
     ...
     * @var array
     */
	public $tasks = array('Project', 'DbConfig', 'Model', 'Controller', 'Javascript', 'View', 'Plugin', 'Fixture', 'Test');
	...
	public function main() {
		...
		$classToBake = strtoupper($this->in(__d('cake_console', 'What would you like to Bake?'), array('D', 'M', 'V', 'C', 'J', 'P', 'F', 'T', 'Q')));
		switch ($classToBake) {
			case 'D':
			...
			case 'Q':
				...
				break;
			default:
				$this->out(__d('cake_console', 'You have made an invalid selection. Please choose a type of class to Bake by entering D, M, V, J, F, T, or C.'));
		}
		$this->hr();
		$this->main();
	}
